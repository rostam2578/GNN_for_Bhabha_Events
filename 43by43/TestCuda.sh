...
#SBATCH --output=/hpcfs/bes/mlgpu/hoseinkk/MLTracking/bhabha/GNN/TestCuda.out
...
#isource /home/bes/hoseinkk/.bin/env_ml_lxslc7.sh
#time(python bhabha_training_gpu.py)

#python ./20210504_BhabhaGNN.ipynb
#time(python train_local.py)
